...
public partial class _default : BasePage
{
    ...
    protected int SoundFileLengthK { get { return 105; } }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (Functions.IsEmptyString(formProblems))
        {
            ...
            try
            {
                ...
                //
                string url = Functions.CombineUrlElements(Config.ServerName, string.Format("default.aspx?{0}={1}", QS_SUBMITOK, HttpUtility.UrlEncode(txtName.Text)));
